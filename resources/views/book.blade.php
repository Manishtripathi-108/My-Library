                    ...
                    <div class="page-num-1">
                        <div class="pages-content">
                            ...
                            <div class="content-inner">
                                <h1>Chapter 1</h1>
                                <div class="text">
                                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptas ea non vitae a assumenda sint quod, dolores laboriosam velit corrupti nobis cupiditate perspiciatis natus exercitationem, architecto esse ratione blanditiis! Itaque.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="page-num-3">
                        <div class="pages-content">
                            <div class="content-inner">
                                <h1>Chapter 3</h1>
                                <div class="text">
                                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Voluptate voluptas molestiae tempore amet adipisci dicta incidunt nisi alias distinctio fugit blanditiis dignissimos nobis deserunt eum consequuntur ipsam, perspiciatis numquam repellendus.</p>
...
@push('styles')
    ...
    *:after {
    ...
    body {
    background: linear-gradient(rgba(255, 250, 250, 0.75), rgba(255, 250, 250, 0.75)),
    url(https://image.freepik.com/free-vector/forest-herbs-blue-background_8365-70.jpg);
    background: linear-gradient(rgba(255, 250, 250, 0.75), rgba(255, 250, 250, 0.75)),
    ...
    position: relative;
    margin: 2% auto;
    width: 800px; /* Increased width for a larger book */
    }
