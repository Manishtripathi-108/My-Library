<x-app-layout title="Sunrise Background Animation">
    ...
    @pushOnce('styles')
        <style>
            ...
            *:after {
                ...
                /* Uncomment it if animation needed to be stopped */
            ...
            .cloud {
                ...
                animation: clouds 1100s infinite;
                animation-delay: -10s;
            }
            ...
            .reed {
                ...
                animation: verticalise 100s infinite;
            }
            ...
            .reed-1 {
                ...
                animation: verticalise-1 100s infinite;
