<button class="bg-secondary hover:bg-dim group flex h-12 w-fit cursor-pointer items-center justify-start gap-2 rounded-md border-none px-4 py-1 shadow transition-all duration-300 active:scale-95">
	<span class="relative flex h-fit w-10 flex-col items-center justify-end">
		<svg class="z-10 h-auto w-4/5" viewBox="0 0 146 113" fill="none" xmlns="http://www.w3.org/2000/svg">
		...
		<svg class="absolute z-20 h-auto w-6/12 transition-all duration-300 ease-in group-hover:-translate-y-1" viewBox="0 0 88 99" fill="none" xmlns="http://www.w3.org/2000/svg">
		...
		<svg class="group-hover:trans-rotate-x-30 absolute z-30 h-auto w-5/6 origin-bottom opacity-95 transition-all duration-300 ease-in" viewBox="0 0 160 79" fill="none" xmlns="http://www.w3.org/2000/svg">
