<x-app-layout>
	...
	<div class="*:size-60 *:col-span-1 *:bg-light-primary *:text-center *:text-sm *:rounded-lg *:text-light-text *:tracking-wider *:flex *:justify-center *:items-center grid w-full md:grid-cols-3 grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 xl:grid-cols-5 place-items-center justify-center gap-8 bg-light-primary p-4 font-karla">
		<div class="shadow-neu-sun">shadow-neu-sun</div>
		<div class="shadow-neu-xs">shadow-neu-xs</div>
		<div class="shadow-neu-md">shadow-neu-md</div>
