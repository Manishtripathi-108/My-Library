<x-app-layout>
	...
	<div class="*:size-60 *:col-span-1 *:bg-light-primary *:text-center *:text-sm *:rounded-lg *:text-light-text *:tracking-wider *:flex *:justify-center *:items-center grid w-full grid-cols-1 place-items-center justify-center gap-8 bg-light-primary p-4 font-karla sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5">
	...
	<div class="*:size-60 *:text-center *:text-xs *:bg-dark-primary *:col-span-1 *:rounded-lg *:text-dark-text *:tracking-wider *:flex *:justify-center *:items-center grid grid-cols-1 place-items-center justify-center gap-8 bg-dark-primary p-4 font-karla sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5">
		...
		<div class="shadow-neu-dark-inset-md">shadow-neu-dark-inset-md</div>
