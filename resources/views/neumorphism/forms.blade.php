<x-app-layout title="Forms | Neumorphism">
	...
	<x-grid title="Forms">
		...
		<x-grid.item title="Form Input">
			<form class="w-full md:w-2/3" action="#">
				<div class="neu-form-group mb-4">
					...
					<input class="neu-form-input" id="email" type="email" placeholder="ashborn@godofdeath.sl">
				...
				<div class="neu-form-group mb-4">
					...
					<input class="neu-form-input" id="password" type="password" placeholder="Password">
				</div>
				<div class="neu-form-group mb-4">
			...
			<x-slot name="cssCode">
				<style>
					...
					.neu-form-input {
						@apply bg-primary text-primary w-full active:placeholder:text-primary focus:placeholder:text-primary placeholder:text-secondary appearance-none rounded-lg border border-light-secondary px-3 py-2 font-karla outline-none placeholder:tracking-wide transition duration-300 shadow-neu-xs focus:shadow-neu-inset-xs;
						/* dark mode */
						@apply dark:focus:shadow-neu-dark-inset-xs dark:shadow-neu-dark-xs dark:border-dark-secondary;
					}
		...
		<x-grid.item title="Form with Icons">
			...
			<x-slot name="cssCode">
				<style>
					...
					.neu-input-group {
						@apply flex w-full items-center rounded-lg border border-light-secondary dark:border-dark-secondary dark:shadow-neu-dark-xs shadow-neu-xs focus-within:shadow-none dark:focus-within:shadow-none;
					}

					.neu-input-icon {
						@apply size-10 text-secondary border-light-secondary px-2 py-1 dark:border-dark-secondary;
					}

					.neu-input-group-prepend .neu-form-input {
						@apply rounded-r-lg rounded-l-none shadow-none focus:shadow-neu-inset-xs dark:focus:shadow-neu-dark-inset-xs;
					}
					...
					.neu-input-group-append .neu-form-input {
						@apply rounded-l-lg rounded-r-none shadow-none focus:shadow-neu-inset-xs dark:focus:shadow-neu-dark-inset-xs;
					}

					.neu-input-group-append .neu-input-icon {
						@apply rounded-r-lg rounded-l-none border-l;
					}
		...
		<x-grid.item title="Textarea">
			...
			<x-slot name="cssCode">
				<style>
					.neu-form-textarea {
						@apply bg-primary text-primary w-full active:placeholder:text-primary transition-all duration-500 ease-Out-expo focus:placeholder:text-primary placeholder:text-secondary appearance-none rounded-lg border border-light-secondary px-3 py-2 font-karla outline-none placeholder:tracking-wide shadow-neu-xs focus:shadow-neu-inset-xs;
						/* dark mode */
						@apply dark:focus:shadow-neu-dark-inset-xs dark:shadow-neu-dark-xs dark:border-dark-secondary;
					}
	...
	<x-slot name="rightSidenav">
		<x-sidenav-list>Form Input</x-sidenav-list>
