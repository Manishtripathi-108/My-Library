...
@switch($type)
		...
		<div class="max-w-[350px] lg:w-full">
			<div class="overflow-hidden rounded-lg">
				...
				<h3 class="mt-3 font-semibold">
					<a class="karla-font text-xl font-bold tracking-wide text-[#1979ef] transition-colors duration-300 hover:text-gray-600" href="">
						Product Title
					</a>
				</h3>
	...
	@case(2)
		<div class="max-w-[350px] lg:w-full">
			<div class="bg-primary neu-shadow relative flex min-w-0 flex-col break-words rounded-lg border border-gray-300 bg-clip-border">
				...
				<div class="border-t border-gray-300 p-4">
					...
					<div class="mt-3 flex">
						<x-star rating='4.7' />
						<span class="neu-badge karla-font ml-2 py-1 px-2 text-sm">
							4.7
						</span>
					</div>
					...
					<div class="mt-3 flex items-center justify-between">
						...
						<a class="neu-icon-btn karla-font py-1 text-sm" href="#">
	...
	@case(3)
		<div class="max-w-[350px] md:max-w-fit lg:w-full">
			<div class="bg-primary neu-shadow relative flex min-w-0 flex-col break-words rounded-lg border border-gray-300 p-6">
