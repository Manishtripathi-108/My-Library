    ...
    theme: {
        extend: {
            ...
            boxShadow: {
                ...
                'neu-md': '-5px -5px 9px #edd9c1, 5px 5px 9px #fff9df',
                'neu-lg': '6px 6px 9px #e6d2bb, -6px -6px 9px #ffffe5',
                ...
                'neu-inset-md': 'inset 6px 6px 12px #665d53, inset -6px -6px 12px #ffffff',
                ...
                'neu-dark-md': '6px 6px 12px #000000, -6px -6px 12px #ffe9d03b',
                ...
                'neu-dark-outset-sm': '#5b5b5b40 5px 5px 7px 0px, #00000080 2px 2px 5px 0px inset, #FFFFFF40 -3px -3px 5px 0px inset',
            },
            fontFamily: {
